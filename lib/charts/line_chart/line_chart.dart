...
import 'package:flutter_animated_charts/charts/line_chart/line_chart_painter.dart';
...
class LineChart extends StatefulWidget {
  ...
  final ValueChanged<List<ChartPoint>>? onPointHover;
  final ValueChanged<ChartPoint?>? onPointSelect;
...
class _LineChartState extends State<LineChart> {
  ...
  void _onPointTap(ChartPoint point) {
    ...
    widget.onPointSelect?.call(_controller.selected);
  ...
  void _onPointHover(ChartPoint point, bool isHovered) {
    ...
    widget.onPointHover?.call(_controller.hovered);
  }
}
